...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('assets/css/dashliteee9a.css?ver=3.2.2')}}">
...
<body class="nk-body npc-default pg-auth">
          ...
          <div class="nk-split nk-split-page nk-split-md">
            <div class="nk-split-content nk-block-area nk-block-area-column nk-auth-container bg-white">
              <div class="nk-block nk-block-middle nk-auth-body">
                <div class="brand-logo pb-5"><a href="../../index.html" class="logo-link"><img class="logo-light logo-img logo-img-lg" src="../../images/logo.png" srcset="/demo3/images/logo2x.png 2x" alt="logo"><img class="logo-dark logo-img logo-img-lg" src="../../images/logo-dark.png" srcset="/demo3/images/logo-dark2x.png 2x" alt="logo-dark"></a></div>
                ...
                <form action="#" id="loginform" method="post">
                  ...
                  <div class="form-group">
                    <div class="form-label-group"><label class="form-label" for="password">Passcode</label><a class="link link-primary link-sm" tabindex="-1" href="auth-reset-v3.html">Forgot Code?</a></div>
                    <div class="form-control-wrap"><a tabindex="-1" href="#" class="form-icon form-icon-right passcode-switch lg" data-target="password"><em class="passcode-icon icon-show icon ni ni-eye"></em><em class="passcode-icon icon-hide icon ni ni-eye-off"></em></a><input type="password" class="form-control form-control-lg" id="password" placeholder="Enter your passcode"></div>
                  </div>
                  <div class="form-group"><button class="btn btn-lg btn-primary btn-block">Sign in</button></div>
                </form>
                <div class="form-note-s2 pt-4"> Dont't Have an Account ?<a href="auth-register-v3.html">Register Here</a></div>
  ...
  <script src="{{ asset('assets/js/bundleee9a.js?ver=3.2.2')}}"></script>
  <script src="{{ asset('assets/js/scriptsee9a.js?ver=3.2.2')}}"></script>
  <script src="{{ asset('assets/js/demo-settingsee9a.js?ver=3.2.2')}}"></script>
