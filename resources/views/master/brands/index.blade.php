                                    ...
                                    <div class="toggle-expand-content" data-content="pageMenu">
                                        <ul class="nk-block-tools g-3">
                                            ...
                                            <li class="nk-block-tools-opt">
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalForm">Add Brands</button>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="addbrands" method="post" class="form-validate is-alter">
                    @csrf()
...
<script>
    $(document).on('submit', '#addbrands', function(ev) {
        $('.error').html('');
