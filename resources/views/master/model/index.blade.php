                    ...
                    <div class="nk-block nk-block-lg">
                        <div class="nk-block-head">
                            <div class="nk-block-head-content">
                                <h4 class="nk-block-title">Model</h4>
                                    ...
                                    <div class="toggle-expand-content" data-content="pageMenu">
                                        <ul class="nk-block-tools g-3">
                                            ...
                                            <li class="nk-block-tools-opt">
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalForm">Add Model</button>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr class="bg-theme">
                                            ...
                                            <th scope="col" class="bg-theme">Brand Name</th>
                                            <th scope="col" class="bg-theme">Category Name</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $value->brand_details->name}}</td>
                                            <td>{{ $value->category_details->name}}</td>
                                            <td>{{ $value->name}}</td>
                                            <td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="addmodel" method="post" class="form-validate is-alter">
                    @csrf()
                        ...
                        <div class="form-control-wrap ">
                            <div class="form-control-select">
                                <select class="form-control" id="brand_id" name="brand_id">
                                    ...
                                    @if(!empty($fetchbrand))
                                        @foreach($fetchbrand as $key => $value)
                    ...
                    <div class="form-group">
                        <label class="form-label" for="category_id">Default Select</label>
                        <div class="form-control-wrap ">
                            <div class="form-control-select">
...
<script>
    $(document).on('submit', '#addmodel', function(ev) {
        $('.error').html('');
