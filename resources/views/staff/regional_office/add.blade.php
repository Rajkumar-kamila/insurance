                    ...
                    <div class="nk-block nk-block-lg">
                        <div class="nk-block-head">
                            <div class="nk-block-head-content">
                                <h4 class="nk-block-title">Regional Office</h4>
                                    ...
                                    <div class="toggle-expand-content" data-content="pageMenu">
                                        <ul class="nk-block-tools g-3">
                                            ...
                                            <li class="nk-block-tools-opt">
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalForm">Add Regional Office</button>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add Regional Office</h5>
            ...
            <div class="modal-body">
                ...
                <form id="addregionaloffice" method="post" class="form-validate is-alter">
                    @csrf()
...
<script>
    $(document).on('submit', '#addregionaloffice', function(ev) {
        $('.error').html('');
        ...
        if (error == false) {
            $.ajax({
                url: "{{ url('staff/regionaloffice/store') }} ",
                type: 'post',
                data: formData,
                cache: false,
                contentType: false,
