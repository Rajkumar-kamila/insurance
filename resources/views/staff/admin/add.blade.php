        ...
        <div class="col-span-12 flex items-center justify-between gap-3 bg-white p-3 rounded-5 2sm:flex-col 2sm:items-end dark:bg-sidebar-dark">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu !w-36 !top-11 left-0 rtl:left-unset rtl:!right-0">
                        <ul class="flex flex-col cursor-pointer">
                            <a href="{{ url('exportadmin') }}"><li class="px-2 py-1 rounded hover:bg-gray-light dark:hover:bg-sidebar-dark2"> Excel </li></a>
                            <a><li class="px-2 py-1 rounded hover:bg-gray-light dark:hover:bg-sidebar-dark2"> PDF </li></a>
                        </ul>                                    
                    </div>
                </div> 
            </div>
            <div class="flex items-center gap-3">
                ...
                <div class="product-setting">
                    ...
                    <label class="button-label btn-primary" for="modal-1">Add Admin</label>
                </div>
            ...
            <div class="card">
                <div class="card-header transaction-history">
                    <div class="flex justify-between w-full flex-wrap gap-2 items-center">
                        <h3 class="text-lg font-bold text-title leading-none">Admin</h3>
...
<div class="modal-main dark:bg-sidebar-dark">
    ...
    <div class="modal peer-checked:opacity-100 peer-checked:visible w-[25.75rem] dark:bg-sidebar-dark2" style="width: 30%;">
        ...
        <form class="theme-form flex flex-col gap-3" id="addadmin" method="post">
                    ...
                    <table class="table equal-space head-table">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td class="min-w-[8.125rem]">{{$value->sidebar_name}}</td>
                            <td class="min-w-[11.125rem]">
                                <div class="flex items-center gap-2"> 
                                    <label class="cursor-pointer checkbox checkbox-md">
                                        <input type="checkbox" class="peer" name="read_{{ $value->sidebar_id}}" id="remember" value="1"/>
                                    </label>
                                </div>
                            </td>
                            <td class="min-w-[11.125rem]">
                                <div class="flex items-center gap-2"> 
                                    <label class="cursor-pointer checkbox checkbox-md">
                                        <input type="checkbox" class="peer" name="write_{{ $value->sidebar_id}}" id="remember" value="1"/>
...
<script>
    $(document).on('submit', '#addadmin', function(ev) {
        $('.error').html('');
